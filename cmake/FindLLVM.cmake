...
# at www.opengtl.org
#
# To specify a version of LLVM, user must specify LLVM_DEV_DIR environment variable
#
...
if (LLVM_INCLUDE_DIR)
  ...
  exec_program(${LLVM_CONFIG_EXECUTABLE} ARGS --bindir OUTPUT_VARIABLE LLVM_BIN_DIR)
  MESSAGE(STATUS "LLVM binary directory: " ${LLVM_BIN_DIR})
